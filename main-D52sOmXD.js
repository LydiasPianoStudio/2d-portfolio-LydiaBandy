import y from"https://unpkg.com/kaboom@3000.1.17/dist/kaboom.mjs";(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function r(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(a){if(a.ep)return;a.ep=!0;const o=r(a);fetch(a.href,o)}})();const p=4,h={pc:`
...
`,exit:`<div style="text-align: left; font-family: 'Segoe UI', sans-serif; line-height: 1.6;">
  ...
  <br>Feel free to check out my website at
   <a href="https://lydiaspianostudio.com/" target="_blank">LydiasPianoStudio</a>,
    just close the tab and stop by anytime!`},t=y({global:!1,touchToMouse:!0,canvas:document.getElementById("game"),debug:!1});function b(n,l){const r=document.getElementById("textbox-container"),e=document.getElementById("dialogue");r.style.display="block";let a=0,o="";const i=setInterval(()=>{if(a<n.length){o+=n[a],e.innerHTML=o,a++;return}clearInterval(i)},1),s=document.getElementById("close");function d(){l(),r.style.display="none",e.innerHTML="",clearInterval(i),s.removeEventListener("click",d)}s.addEventListener("click",d),addEventListener("keypress",c=>{c.code==="Enter"&&s.click()})}function u(n){n.width()/n.height()<1?n.camScale(n.vec2(1)):n.camScale(n.vec2(1.5))}var m,f;const g=((f=(m=import.meta)==null?void 0:m.env)==null?void 0:f.BASE_URL)||"/2d-portfolio-LydiaBandy/";async function w(){try{t.loadRoot(g),console.log("Loading assets from:",g);try{const r=new FontFace("monogram","url(monogram.ttf)");await r.load(),document.fonts.add(r),console.log("Font loaded successfully")}catch(r){throw console.error("Font loading error:",r),r}return t.loadSprite("spritesheet","spritesheet.png",{sliceX:39,sliceY:31,anims:{"idle-down":952,"walk-down":{from:952,to:955,loop:!0,speed:8},"idle-side":991,"walk-side":{from:991,to:994,loop:!0,speed:8},"idle-up":1030,"walk-up":{from:1030,to:1033,loop:!0,speed:8}}}),t.loadSprite("map","map.png"),t.loadFont("monogram","monogram.ttf"),t.setBackground(t.Color.fromHex("#0013de")),{mapData:await(await fetch(`${g}map.json`)).json()}}catch(n){throw console.error("Failed to preload assets:",n),n}}async function v(){try{const{mapData:n}=await w();console.log("Assets loaded!"),t.scene("main",()=>k(n)),t.go("main")}catch(n){console.error("Failed to preload assets:",n)}}function k(n){const l=n.layers,r=t.add([t.sprite("map"),t.pos(0),t.scale(p)]),e=t.make([t.sprite("spritesheet",{anim:"idle-down"}),t.area({shape:new t.Rect(t.vec2(0,3),10,10)}),t.body(),t.anchor("center"),t.pos(),t.scale(p),{speed:250,direction:"down",isInDialogue:!1},"player"]);for(const o of l){if(o.name==="boundaries"){for(const i of o.objects)r.add([t.area({shape:new t.Rect(t.vec2(0),i.width,i.height)}),t.body({isStatic:!0}),t.pos(i.x,i.y),i.name]),i.name&&e.onCollide(i.name,()=>{e.isInDialogue=!0,b(h[i.name],()=>e.isInDialogue=!1)});continue}if(o.name==="spawnpoints"){for(const i of o.objects)if(i.name==="player"){e.pos=t.vec2((r.pos.x+i.x)*p,(r.pos.y+i.y)*p),t.add(e);continue}}}u(t),t.onResize(()=>u(t)),t.onUpdate(()=>{t.camPos(e.worldPos().x,e.worldPos().y-100)}),t.onMouseDown(o=>{if(o!=="left"||e.isInDialogue)return;const i=t.toWorld(t.mousePos());e.moveTo(i,e.speed);const s=e.pos.angle(i),d=50,c=125;if(s>d&&s<c){e.curAnim()!=="walk-up"&&e.play("walk-up"),e.direction="up";return}if(s<-d&&s>-c){e.curAnim()!=="walk-down"&&e.play("walk-down"),e.direction="down";return}if(Math.abs(s)>c){e.flipX=!1,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="right";return}Math.abs(s)<d&&(e.flipX=!0,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="left")});function a(){e.direction==="down"?e.play("idle-down"):e.direction==="up"?e.play("idle-up"):e.play("idle-side")}t.onMouseRelease(a),t.onKeyRelease(a),t.onKeyDown(()=>{const o=[t.isKeyDown("right"),t.isKeyDown("left"),t.isKeyDown("up"),t.isKeyDown("down")];if(!(o.filter(Boolean).length>1)&&!e.isInDialogue){if(o[0]){e.flipX=!1,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="right",e.move(e.speed,0);return}if(o[1]){e.flipX=!0,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="left",e.move(-e.speed,0);return}if(o[2]){e.curAnim()!=="walk-up"&&e.play("walk-up"),e.direction="up",e.move(0,-e.speed);return}o[3]&&(e.curAnim()!=="walk-down"&&e.play("walk-down"),e.direction="down",e.move(0,e.speed))}})}v();
