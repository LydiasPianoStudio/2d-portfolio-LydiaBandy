...
`,exit:`<div style="text-align: left; font-family: 'Segoe UI', sans-serif; line-height: 1.6;">
  ...
  <br>Feel free to check out my website at
   <a href="https://lydiaspianostudio.com/" target="_blank">LydiasPianoStudio</a>,
    just close the tab and stop by anytime!`},t=y({global:!1,touchToMouse:!0,canvas:document.getElementById("game"),debug:!1});function b(o,r){const l=document.getElementById("textbox-container"),e=document.getElementById("dialogue");l.style.display="block";let n=0,i="";const a=setInterval(()=>{if(n<o.length){i+=o[n],e.innerHTML=i,n++;return}clearInterval(a)},1),s=document.getElementById("close");function c(){r(),l.style.display="none",e.innerHTML="",clearInterval(a),s.removeEventListener("click",c)}s.addEventListener("click",c),addEventListener("keypress",p=>{p.code==="Enter"&&s.click()})}function u(o){o.width()/o.height()<1?o.camScale(o.vec2(1)):o.camScale(o.vec2(1.5))}var m,f;const d=((f=(m=import.meta)==null?void 0:m.env)==null?void 0:f.BASE_URL)||"/2d-portfolio-LydiaBandy/";async function w(){try{t.loadRoot(""),console.log("Loading assets from:",d);try{console.log("Loading spritesheet..."),await t.loadSprite("spritesheet",`${d}spritesheet.png`,{sliceX:39,sliceY:31,anims:{"idle-down":952,"walk-down":{from:952,to:955,loop:!0,speed:8},"idle-side":991,"walk-side":{from:991,to:994,loop:!0,speed:8},"idle-up":1030,"walk-up":{from:1030,to:1033,loop:!0,speed:8}}}),console.log("✓ Spritesheet loaded"),console.log("Loading map sprite..."),await t.loadSprite("map",`${d}map.png`),console.log("✓ Map sprite loaded")}catch(o){throw console.error("Sprite loading failed:",o),console.log("Attempted URLs:",{spritesheet:`${d}spritesheet.png`,map:`${d}map.png`}),o}t.setBackground(t.Color.fromHex("#0013de"));try{console.log("Loading map data...");const o=await fetch(`${d}map.json`);if(!o.ok)throw new Error(`HTTP error! status: ${o.status}`);const r=await o.json();return console.log("✓ Map data loaded"),{mapData:r}}catch(o){throw console.error("Map data loading failed:",o),console.log("Attempted map URL:",`${d}map.json`),o}}catch(o){throw console.error("Asset loading failed:",o),o}}async function v(){try{const{mapData:o}=await w();console.log("Assets loaded!"),t.scene("main",()=>k(o)),t.go("main")}catch(o){console.error("Failed to preload assets:",o)}}function k(o){const r=o.layers,l=t.add([t.sprite("map"),t.pos(0),t.scale(g)]),e=t.make([t.sprite("spritesheet",{anim:"idle-down"}),t.area({shape:new t.Rect(t.vec2(0,3),10,10)}),t.body(),t.anchor("center"),t.pos(),t.scale(g),{speed:250,direction:"down",isInDialogue:!1},"player"]);for(const i of r){if(i.name==="boundaries"){for(const a of i.objects)l.add([t.area({shape:new t.Rect(t.vec2(0),a.width,a.height)}),t.body({isStatic:!0}),t.pos(a.x,a.y),a.name]),a.name&&e.onCollide(a.name,()=>{e.isInDialogue=!0,b(h[a.name],()=>e.isInDialogue=!1)});continue}if(i.name==="spawnpoints"){for(const a of i.objects)if(a.name==="player"){e.pos=t.vec2((l.pos.x+a.x)*g,(l.pos.y+a.y)*g),t.add(e);continue}}}u(t),t.onResize(()=>u(t)),t.onUpdate(()=>{t.camPos(e.worldPos().x,e.worldPos().y-100)}),t.onMouseDown(i=>{if(i!=="left"||e.isInDialogue)return;const a=t.toWorld(t.mousePos());e.moveTo(a,e.speed);const s=e.pos.angle(a),c=50,p=125;if(s>c&&s<p){e.curAnim()!=="walk-up"&&e.play("walk-up"),e.direction="up";return}if(s<-c&&s>-p){e.curAnim()!=="walk-down"&&e.play("walk-down"),e.direction="down";return}if(Math.abs(s)>p){e.flipX=!1,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="right";return}Math.abs(s)<c&&(e.flipX=!0,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="left")});function n(){e.direction==="down"?e.play("idle-down"):e.direction==="up"?e.play("idle-up"):e.play("idle-side")}t.onMouseRelease(n),t.onKeyRelease(n),t.onKeyDown(()=>{const i=[t.isKeyDown("right"),t.isKeyDown("left"),t.isKeyDown("up"),t.isKeyDown("down")];if(!(i.filter(Boolean).length>1)&&!e.isInDialogue){if(i[0]){e.flipX=!1,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="right",e.move(e.speed,0);return}if(i[1]){e.flipX=!0,e.curAnim()!=="walk-side"&&e.play("walk-side"),e.direction="left",e.move(-e.speed,0);return}if(i[2]){e.curAnim()!=="walk-up"&&e.play("walk-up"),e.direction="up",e.move(0,-e.speed);return}i[3]&&(e.curAnim()!=="walk-down"&&e.play("walk-down"),e.direction="down",e.move(0,e.speed))}})}v();
